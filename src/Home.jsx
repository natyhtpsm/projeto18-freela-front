            ...
            <div>
                ...
                {showForm ? (
                    <form onSubmit={handleCreateProduct}>
                        ...
                        <input type="text" value={phoneSeller} onChange={(e) => setPhoneSeller(e.target.value)} required /><br />

                        <button type="submit" onClick={handleCreateProduct}>Criar Produto</button>
                    </form>
                ) : (
